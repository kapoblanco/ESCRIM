...
public class JFrame_Principale extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Mon Label");

        jTextField1.setText("Nom du colis");

        jButton1.setText("Créer colis");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String message = "Création du colis " + jTextField1.getText();
        LOGGER.info(message);
        ControllerColis.getController().creerColis(jTextField1.getText());
